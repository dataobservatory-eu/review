...
After the review has been carried out, `explain()` records how that activity was performed:
...
This deliberately separates **prescription** from **documentation**. `review()` defines what should be reviewed, whereas `explain()` records what actually happened.
