...
- [The Review Algebra](https://review.dataobservatory.eu/articles/intro.html), introducing the review workflow and its underlying concepts.
- [From Review Algebra to Provenance Modelling](https://review.dataobservatory.eu/articles/prov.html), describing how review activities, agents, and resources are recorded using a lightweight provenance model inspired by W3C PROV.
